...
from AarohixMusic.utils.stream.stream import stream
...
def contains_illegal_content(text):
    ...
    for word in BLACKLIST_WORDS:
        ...
        if re.search(word_pattern, text_clean, re.IGNORECASE):
            return True
...
async def play_commnd(
    ...
    if url:
        ...
        if contains_illegal_content(url):
            return await mystic.edit_text(
                ...
                "<b>This request contains prohibited content.</b>\n"
    ...
    if audio_telegram:
        ...
        if contains_illegal_content(file_name_check):
            return await mystic.edit_text(
                "⚠️ <b>Content Blocked!</b>\n\n"
                "<b>This file contains prohibited content.</b>"
            )
        ...
        if await YouTube.exists(url):
            if "playlist" in url:
                ...
                if contains_illegal_content(details.get("title", "")):
                    return await mystic.edit_text(
                        "⚠️ <b>Content Blocked!</b>\n\n"
                        "<b>This video contains prohibited content.</b>"
                    )
            ...
            if "track" in url:
                ...
                if contains_illegal_content(details.get("title", "")):
                    return await mystic.edit_text(
                        "⚠️ <b>Content Blocked!</b>\n\n"
                        "<b>This track contains prohibited content.</b>"
                    )
        ...
        if contains_illegal_content(details.get("title", "")):
            return await mystic.edit_text(
                "⚠️ <b>Content Blocked!</b>\n\n"
                "<b>This search result contains prohibited content.</b>"
            )
