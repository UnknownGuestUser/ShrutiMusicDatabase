...
from AarohixMusic.utils.decorators.admins import ActualAdminCB
from AarohixMusic.utils.decorators.language import language, languageCB
from AarohixMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from AarohixMusic.utils.inline.start import private_panel
    ...
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("🎧 Only Music Bot Repo", url="https://github.com/NoxxOP/AarohixMusic")]
            ]
        ),
