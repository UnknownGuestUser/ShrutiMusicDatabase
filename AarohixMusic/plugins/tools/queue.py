...
from AarohixMusic.utils import ShrutiBin, get_channeplayCB, seconds_to_min
from AarohixMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from AarohixMusic.utils.decorators.language import language, languageCB
from AarohixMusic.utils.inline import queue_back_markup, queue_markup
...
async def get_queue(client, message: Message, _):
    ...
    cap = _["queue_8"].format(nand.mention, title, typo, user, send)
    upl = (
