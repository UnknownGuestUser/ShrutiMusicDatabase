...
from AarohixMusic.utils import extract_user, int_to_alpha
...
from AarohixMusic.utils.decorators import AdminActual, language
from AarohixMusic.utils.inline import close_markup
from config import BANNED_USERS, adminlist


@nand.on_message(filters.command("auth") & filters.group & ~BANNED_USERS)
@AdminActual
...
@nand.on_message(filters.command("unauth") & filters.group & ~BANNED_USERS)
@AdminActual
