...
from AarohixMusic.utils import AdminRightsCheck
from AarohixMusic.utils.database import is_active_chat, is_nonadmin_chat
from AarohixMusic.utils.decorators.language import languageCB
from AarohixMusic.utils.inline import close_markup, speed_markup
...
async def playback(cli, message: Message, _, chat_id):
    ...
    return await message.reply_text(
        text=_["admin_28"].format(nand.mention),
        reply_markup=upl,
    )


@nand.on_callback_query(filters.regex("SpeedUP") & ~BANNED_USERS)
@languageCB
